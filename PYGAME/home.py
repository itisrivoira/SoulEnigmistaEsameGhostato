...
sfondoGioco=pygame.image.load("img/5C.jpg").convert()
logo=pygame.image.load("img/logo.png").convert_alpha()
banco=pygame.image.load("img/banchi.jpg").convert_alpha()
armadio=pygame.image.load("img/armadio.jpg").convert_alpha()
cestini=pygame.image.load("img/cestini.jpg").convert_alpha()
lavagna=pygame.image.load("img/lavagna.jpg").convert_alpha()
